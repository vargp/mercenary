...
char[57] = {what: "unit", type: "neut", title: "Valami Valami", trait: "Ranger Hero", dmg: 6, hp: 12, trig: 26, text: "While Present:<br>The DMG of your Units can't be decreased.", perc: 25, cost: 20};
...
en[12] = {what: "monst", type: "monst", title: "Haunting Banshee", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 14, text: "When she dies:<br>She reappears in the next slot. (Doesn't work in the rightmost slot.)" };
...
en[24] = {what: "monst", type: "monst", title: "Servant of the Abyss", trait: "Demon Enemy", dmg: 4, hp: 16, trig: 16, text: "When Appears:<br>Place a \"Dread of Doom\"<br>Disadvantage card<br>into your Hand." };
en[25] = {what: "monst", type: "monst", title: "Mystic Boar", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 16, text: "Before Combat:<br>Discard the cards that you<br>wanted to Keep." };
...
en[28] = {what: "monst", type: "monst", title: "Unholy Bloodpriest", trait: "Demon Enemy", dmg: 4, hp: 16, trig: 16, text: "When Appears:<br>Place a \"Curse of Weakness\"<br>Disadvantage card<br>into your Hand." };
en[29] = {what: "monst", type: "monst", title: "Darkfire Summoner", trait: "Demon Enemy", dmg: 4, hp: 16, trig: 1, text: "Before Combat:<br>A new Enemy appears<br>in the 2nd slot." };
...
en[37] = {what: "monst", type: "monst", title: "Vicious Soothsayer", trait: "Orc Enemy", dmg: 4, hp: 16, trig: 21, text: "When you lose Battlescore:<br>Your Commander loses 3 HP." };
...
en[39] = {what: "monst", type: "monst", title: "Swamp Hag", trait: "Orc Enemy", dmg: 4, hp: 16, trig: 1, text: "Before Combat:<br>Place a \"Chaos Curse\"<br>Disadvantage card<br>into your Hand."};
...
en[42] = {what: "monst", type: "monst", title: "Goblin Pickpocket", trait: "Orc Enemy", dmg: 4, hp: 16, trig: 1, text: "After Combat:<br>Lose 5 Gold." };
en[43] = {what: "monst", type: "monst", title: "Jungle Raider", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 1, text: "Before Combat:<br>Discard the Advantage cards from your Hand." };
en[44] = {what: "monst", type: "monst", title: "Vermin Archer", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 1, text: "Before Combat:<br>Discard the Skill cards from your Hand." };
en[45] = {what: "monst", type: "monst", title: "Lycanthrope Terror", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 9, text: "If you draw a Unit with less than 8 Health left, discard it." };
...
en[48] = {what: "monst", type: "monst", title: "White Stag of Legends", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 14, text: "When Killed:<br>Lose 2 Fame." };
en[49] = {what: "monst", type: "monst", title: "Nimble Rougarou", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 16, text: "When Appears:<br>Place an \"Outmaneuvered\"<br>Disadvantage card<br>into your Deck." };
en[50] = {what: "monst", type: "monst", title: "Winged Chimera", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 10, text: "When you discard a card from your Hand:<br>It gains +1 DMG." };
en[51] = {what: "monst", type: "monst", title: "Stoneskin Behemoth", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 3, text: "After attacking:<br>Discard the leftmost card from your Hand." };
en[52] = {what: "monst", type: "monst", title: "Vengeful Howler", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 14, text: "When another Enemy loses HP, this gains +1 DMG." };
...
en[55] = {what: "monst", type: "monst", title: "Rabid Wolfman", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 2, text: "Before Attacking:<br>Instead of the 2nd Unit assigned to it, it attacks the 1st one again (if still alive)." };
en[56] = {what: "monst", type: "monst", title: "Moss Carcass", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 16, text: "When Appears:<br>Give Disadvantages in your deck +8 Speed." };
en[57] = {what: "monst", type: "monst", title: "Shambling Cadaver", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 1, text: "Before Combat:<br>Draw a random Disadvantage card from your deck." };
en[58] = {what: "monst", type: "monst", title: "Graveyard Remains", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 14, text: "When Killed:<br>Put a \"Poison Cloud\"<br>Disadvantage card<br>into your Hand." };
en[59] = {what: "monst", type: "monst", title: "Bone Collector", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 16, text: "When Appears:<br>She gains +1 DMG and +2 HP for each Disadvantage in your Hand or Deck." };
en[60] = {what: "monst", type: "monst", title: "Shade of the Netherworld", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 14, text: "When Killed:<br>Turn this Region into a \"Desolate Waste\"." };
...
en[62] = {what: "monst", type: "monst", title: "Lord of Death", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 14, text: "When another Enemy dies:<br>Resurrect that Enemy." };
en[63] = {what: "monst", type: "monst", title: "Blasphemous Lich", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 16, text: "When Appears:<br>Put a \"Curse of Weakness\"<br>Disadvantage card<br>into your Hand." };
...
en[65] = {what: "monst", type: "monst", title: "Liege of Darkness", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 1, text: "Before Combat:<br>Remove all Advantage cards from your Deck for the rest of this Battle." };
...
en[68] = {what: "monst", type: "monst", title: "Unburied Revenant", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 1, text: "Before Combat:<br>Its Health is restored to ?? (small max)." };
en[69] = {what: "monst", type: "monst", title: "Skeleton Ranger", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 1, text: "Before Combat:<br>Put a current<br>Terrain Disadvantage card<br>into your Hand." };
en[70] = {what: "monst", type: "monst", title: "Firebeard Pirate", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 14, text: "When it dies:<br>non-Rogue Units assigned to it take 4 Damage." };
...
en[72] = {what: "monst", type: "monst", title: "Vampire Monarch", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 16, text: "When Appears:<br>Put a \"Vampiric Touch\"<br>Disadvantage card<br>into your Hand." };
en[73] = {what: "monst", type: "monst", title: "Repugnant Ghoul", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 5, text: "After a Unit attacks it:<br>It regains 3 Health unless that Unit is a Cleric." };
en[74] = {what: "monst", type: "monst", title: "Ominous Corruptor", trait: "Demon Enemy", dmg: 4, hp: 16, trig: 1, text: "Before Combat:<br>Non-Mage Units assigned to it lose 2 DMG." };
...
en[76] = {what: "monst", type: "monst", title: "Steelclaw Bear", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 19, text: "At the start of the Round:<br>(nagy de) Draw the last Ranger from your deck." };
en[77] = {what: "monst", type: "monst", title: "Unyielding Wight", trait: "Undead Enemy", dmg: 4, hp: 16, trig: 5, text: "After it takes Damage:<br>If it has 4 or less HP, it regains 4 HP." };
en[78] = {what: "monst", type: "monst", title: "Beguiling Temptress", trait: "Demon Enemy", dmg: 4, hp: 16, trig: 1, text: "When you gain Battlescore:<br>All of your Units lose that much Speed." };
...
en[80] = {what: "monst", type: "monst", title: "Feral Dragon", trait: "Beast Enemy", dmg: 4, hp: 16, trig: 19, text: "When an Enemy appears:<br>This gains +2 DMG." };

// dread of doom: after combat: every present unit loses 1 health and 1 dmg
// demon curse: all present untis lose 1 DMG and 4 Speed.
// ork curse: 1st units cant retaliate
// ork war cry: enemies + DMG
// beast "overwhelmint numbers": when drawn: 2nd, 3rd slot -> Enemy
// beast other curse: when drawn? discard from hand cards lower than X speed
// undead poison cloud: _every_ unit loses 1 hp
// undead curse of weakness: disadv: commander cant retaliate against 1st enemy
// undead dark forces: after combat: present enemies gain +3 HP
// undead vampiric touch: before combat: present units lose 1 HP and present enemies gain 1 HP. 
...
reg[9] = {type: "region", what: "swamp", title: "Valami Valami", trait: "Swamp Region", fmod: 1, trig: 18, text: "At the start of battle, your Units lose 2 Health here."};
reg[10] = {type: "region", what: "fortress", title: "Valami Valami", trait: "Fortress Region", fmod: -1, trig: 18, text: "2 Ardent Recruits are put into your deck for this battle."};
reg[11] = {type: "region", what: "fortress", title: "Valami Valami", trait: "Fortress Region", fmod: 1, trig: 18, text: "When you gain Battlescore, you gain 1 less here."};
reg[12] = {type: "region", what: "swamp", title: "Valami Valami", trait: "Swamp Region", fmod: 1, trig: 18, text: "Additional Undead may attack you here."};
reg[13] = {type: "region", what: "mountain", title: "Valami Valami", trait: "Mountain Region", fmod: 1, trig: 18,  text: "Additional Demons may attack you here."};
reg[14] = {type: "region", what: "woodland", title: "Valami Valami", trait: "Woodlands Region", fmod: 1, trig: 18, text: "Start the battle with +2 Fortress Terrain Disadvantage in your deck."};
reg[15] = {type: "region", what: "plains", title: "Valami Valami", trait: "Plains Region", fmod: -1, trig: 18, text: "At battle start, your cards with less than 20 Speed gain 4 Speed here (except Disadvantages)."};
reg[16] = {type: "region", what: "fortress", title: "Valami Valami", trait: "Fortress Region", fmod: -1, trig: 18, text: "Enemies have -2 Health here."};
reg[17] = {type: "region", what: "swamp", title: "Valami Valami", trait: "Swamp Region", fmod: -1, trig: 18, text: "Start the battle with +2 Plains Terrain Advantage in your deck."};
reg[18] = {type: "region", what: "mountain", title: "Valami Valami", trait: "Mountain Region", fmod: -1, trig: 18,  text: "Start the battle with +2 Fortress Terrain Advantage in your deck."};
reg[19] = {type: "region", what: "woodland", title: "Valami Valami", trait: "Woodlands Region", fmod: -1, trig: 18, text: "At the end of each round, if you have no Units in your Hand, deal each Enemy 2 Damage."};
reg[20] = {type: "region", what: "plains", title: "Valami Valami", trait: "Plains Region", fmod: -1, trig: 18, text: "At the start of battle, your Units gain 2 Health here."};
reg[21] = {type: "region", what: "fortress", title: "Valami Valami", trait: "Fortress Region", fmod: -1, trig: 18, text: "2nd and 3rd Enemies are less likely to appear here."};
reg[22] = {type: "region", what: "swamp", title: "Valami Valami", trait: "Swamp Region", fmod: 1, trig: 18, text: "Start the battle with +2 Woodlands Terrain Disadvantage in your deck."};
reg[23] = {type: "region", what: "mountain", title: "Valami Valami", trait: "Mountain Region", fmod: 1, trig: 18,  text: "Start the battle with +2 Swamp Terrain Disadvantage in your deck."};
reg[24] = {type: "region", what: "woodland", title: "Valami Valami", trait: "Woodlands Region", fmod: 1, trig: 18, text: "At the end of each round, if there are no Enemies alive, deal each present Unit 1 Damage."};
reg[25] = {type: "region", what: "plains", title: "Valami Valami", trait: "Plains Region", fmod: 1, trig: 18, text: "Additional Orcs may attack you here."};
reg[26] = {type: "region", what: "fortress", title: "Valami Valami", trait: "Fortress Region", fmod: -1, trig: 18, text: "Start the battle with +2 Woodlands Terrain Advantage in your deck."};
reg[27] = {type: "region", what: "swamp", title: "Valami Valami", trait: "Swamp Region", fmod: -1, trig: 18, text: "At battle start, your Mage Units<br>gain +2 DMG here."};
reg[28] = {type: "region", what: "mountain", title: "Valami Valami", trait: "Mountain Region", fmod: -1, trig: 18,  text: "At battle start, your Cleric Units<br>gain +2 DMG here."};
reg[29] = {type: "region", what: "woodland", title: "Valami Valami", trait: "Woodlands Region", fmod: -1, trig: 18, text: "At battle start, your Rogue Units<br>gain +2 DMG here."};
reg[30] = {type: "region", what: "plains", title: "Valami Valami", trait: "Plains Region", fmod: -1, trig: 18, text: "Start the battle with +2 Mountains Terrain Advantage in your deck."};
reg[31] = {type: "region", what: "fortress", title: "Valami Valami", trait: "Fortress Region", fmod: 1, trig: 18, text: "Start the battle with +2 Plains Terrain Disadvantage in your deck."};
reg[32] = {type: "region", what: "swamp", title: "Valami Valami", trait: "Swamp Region", fmod: 1, trig: 18, text: "At battle start, your Warrior Units<br>gain -2 DMG here."};
reg[33] = {type: "region", what: "mountain", title: "Valami Valami", trait: "Mountain Region", fmod: 1, trig: 18,  text: "At the start of each round, if there is only 1 Enemy present, it gains +1 DMG and +3 HP."};
reg[34] = {type: "region", what: "woodland", title: "Valami Valami", trait: "Woodlands Region", fmod: 1, trig: 18, text: "At battle start, your Mage Units<br>gain -2 DMG here."};
reg[35] = {type: "region", what: "plains", title: "Valami Valami", trait: "Plains Region", fmod: 1, trig: 18, text: "Start the battle with +2 Mountains Terrain Disadvantage in your deck."};
reg[36] = {type: "region", what: "fortress", title: "Valami Valami", trait: "Fortress Region", fmod: 1, trig: 18, text: "At battle start, your Cleric Units<br>gain -2 DMG here."};
reg[37] = {type: "region", what: "swamp", title: "Valami Valami", trait: "Swamp Region", fmod: 1, trig: 18, text: "At battle start, your Commander gains -2 DMG here."};
reg[38] = {type: "region", what: "mountain", title: "Valami Valami", trait: "Mountain Region", fmod: 1, trig: 18,  text: "The Healer's healing power is decreased by 2 here."};
reg[39] = {type: "region", what: "woodland", title: "Valami Valami", trait: "Woodlands Region", fmod: -1, trig: 18, text: "The Healer's healing power is increased by 2 here."};
reg[40] = {type: "region", what: "plains", title: "Valami Valami", trait: "Plains Region", fmod: 1, trig: 18, text: "At battle start, your Rogue Units<br>gain -2 DMG here."};
reg[41] = {type: "region", what: "fortress", title: "Valami Valami", trait: "Fortress Region", fmod: -1, trig: 18, text: "When an Enemy appears in the 2nd Slot, its ability is blanked."};
reg[42] = {type: "region", what: "swamp", title: "Valami Valami", trait: "Swamp Region", fmod: -1, trig: 18, text: "At battle start, your commander gains +2 DMG here."};
reg[43] = {type: "region", what: "mountain", title: "Valami Valami", trait: "Mountain Region", fmod: -1, trig: 18,  text: "At the start of each round, if you have any Skills in your hand, draw a Unit that can use one."};
reg[44] = {type: "region", what: "woodland", title: "Valami Valami", trait: "Woodlands Region", fmod: 1, trig: 18, text: "When an Enemy dies, other present Enemies gain +1 DMG and +2 HP."};
reg[45] = {type: "region", what: "plains", title: "Valami Valami", trait: "Plains Region", fmod: -1, trig: 18, text: "At battle start, your Ranger Units<br>gain +2 DMG here."};
reg[46] = {type: "region", what: "fortress", title: "Valami Valami", trait: "Fortress Region", fmod: 1, trig: 18, text: "At the start of each round, if you have no Skills in your hand, discard your leftmost Unit from hand."};
reg[47] = {type: "region", what: "swamp", title: "Valami Valami", trait: "Swamp Region", fmod: -1, trig: 18, text: "When a Unit dies, other present Units gain +2 DMG for the rest of the battle."};
reg[48] = {type: "region", what: "mountain", title: "Valami Valami", trait: "Mountain Region", fmod: -1, trig: 18,  text: "When an Enemy dies, the Unit that killed it is instantly promoted."};
reg[49] = {type: "region", what: "woodland", title: "Valami Valami", trait: "Woodlands Region", fmod: -1, trig: 18, text: "At battle start, give your Units with 20 or less Speed +2 DMG."};
reg[50] = {type: "region", what: "plains", title: "Valami Valami", trait: "Plains Region", fmod: 1, trig: 18, text: "When a Unit dies, other present Units lose all Experience."};
...
reg[52] = {type: "region", what: "plains", title: "Charred Fields", trait: "Plains Region", fmod: -1, trig: 18, text: "Before Combat:<br>Put a random Terrain Disadvantage into your Hand."};
...
ada[4] = {what: "ada", type: "disadv", title: "Lost in the Woods", trait: "Terrain Disadvantage", trig: 9, text: "When Drawn:<br>Discard the leftmost Unit from your Hand.", perc: 15};
...
// fortress disad: Ambush from the Shadows
...
skill[11] = {what: "skill", type: "skred", title: "Valami valami", trait: "Warrior Skill", trig: 1, text: "After Combat:<br>for each Warrior in your Hand, give 3 random Units in your deck<br>+1 DMG and +2 HP for the rest of this battle.", perc: 10, cost: 10};
skill[12] = {what: "skill", type: "skblue", title: "Valami valami", trait: "Cleric Skill", trig: 1, text: "After Combat:<br>If you have a Cleric present, your Commander regains 3 Health.", perc: 10, cost: 10};
skill[13] = {what: "skill", type: "skpurp", title: "Valami valami", trait: "Mage Skill", trig: 1, text: "Before Combat:<br>If the Boss is visible, lower its HP by 2 (to a minimum of 10) if you have a Mage in your Hand.", perc: 10, cost: 10};
skill[14] = {what: "skill", type: "skgreen", title: "Valami valami", trait: "Ranger Skill", trig: 2, text: "When an Enemy appears:<br>If you have a Ranger in your hand, deal that Enemy 2 Damage.", perc: 10, cost: 10};
skill[15] = {what: "skill", type: "skindi", title: "Valami valami", trait: "Rogue Skill", trig: 17, text: "When a Rogue would die:<br>That Rogue remains alive with 1 HP left.", perc: 10, cost: 10};
skill[16] = {what: "skill", type: "skred", title: "Valami valami", trait: "Warrior Skill", trig: 1, text: "After Attacking:<br>If a Warrior kills an Enemy, he deals Damage to the next Enemy too.", perc: 10, cost: 10};
skill[17] = {what: "skill", type: "skblue", title: "Valami valami", trait: "Cleric Skill", trig: 1, text: "After Combat:<br>If you have a Cleric present, each present Unit with less than 5 HP regains 3 Health.", perc: 10, cost: 10};
skill[18] = {what: "skill", type: "skpurp", title: "Valami valami", trait: "Mage Skill", trig: 1, text: "Before Combat:<br>If you have a Mage in your hand, give all your cards (except Disadvantages) +4 Speed.", perc: 10, cost: 10};
skill[19] = {what: "skill", type: "skgreen", title: "Valami valami", trait: "Ranger Skill", trig: 2, text: "Before Combat:<br>place a current Terrain Advantage into your deck for each Ranger present.", perc: 10, cost: 10};
skill[20] = {what: "skill", type: "skindi", title: "Valami valami", trait: "Rogue Skill", trig: 17, text: "When you kill an Enemy:<br>Gain +2 Battlescore for each Rogue in your Hand.", perc: 10, cost: 10};
skill[21] = {what: "skill", type: "skred", title: "Valami valami", trait: "Warrior Skill", trig: 1, text: "Before Combat:<br>If you have a Warrior assigned<br>to the first Enemy and it's not the Enemy with the least HP, swap this with that Enemy.", perc: 10, cost: 10};
skill[22] = {what: "skill", type: "skblue", title: "Valami valami", trait: "Cleric Skill", trig: 1, text: "Before Combat:<br>If you have a Cleric in your Hand, make the Healer appear in the 3rd slot even if there's something else there currently.", perc: 10, cost: 10};
skill[23] = {what: "skill", type: "skpurp", title: "Valami valami", trait: "Mage Skill", trig: 1, text: "Before Combat:<br>Create a copy of the leftmost Mage in your hand (for this battle only).", perc: 10, cost: 10};
skill[24] = {what: "skill", type: "skgreen", title: "Valami valami", trait: "Ranger Skill", trig: 2, text: "Before Combat:<br>If you have a Ranger present,<br>give each present Unit with less<br>than 10 HP +1 DMG for the rest<br>of this battle.", perc: 10, cost: 10};
skill[25] = {what: "skill", type: "skindi", title: "Valami valami", trait: "Rogue Skill", trig: 17, text: "Before Combat: If you have a Rogue present and didn't assign any cards, Combat is skipped this round and new Enemies appear instead of the current ones.", perc: 10, cost: 10};
skill[26] = {what: "skill", type: "skindi", title: "Valami valami", trait: "Rogue Skill", trig: 17, text: "At Round Start: If you have a Rogue present and the Fray is not visible, make the Fray appear in the 1st slot even if there's something else there currently.", perc: 10, cost: 10};
...
skill[28] = {what: "skill", type: "skblue", title: "Valami valami", trait: "Cleric Skill", trig: 1, text: "At the start of a Round:<br>If you have a Cleric in your Hand, draw your slowest Unit.", perc: 10, cost: 10};
skill[29] = {what: "skill", type: "skpurp", title: "Valami valami", trait: "Mage Skill", trig: 1, text: "After Combat:<br>If you have a Mage in your Hand, deal each enemy 2 Damage.", perc: 10, cost: 10};
skill[30] = {what: "skill", type: "skgreen", title: "Valami valami", trait: "Ranger Skill", trig: 2, text: "At the End of the Round:<br>Keep your Rangers that are assigned to Enemies.", perc: 10, cost: 10};
