...
ada[15] = {what: "ada", type: "disadv", title: "Orcish War Cry", trait: "Battle Disadvantage", trig: 6, text: "After Combat:<br>Present Enemies gain +2 DMG.", perc: 15};
...
ada[17] = {what: "ada", type: "disadv", title: "Hunted Down", trait: "Battle Disadvantage", trig: 1, text: "Before Combat:<br>Discard your slowest present Unit.", perc: 15};
...
skill[15] = {what: "skill", type: "skindi", title: "Escape Death", trait: "Rogue Skill", trig: 22, text: "When a Rogue would die:<br>That Rogue remains alive<br>with 1 HP left.", perc: 10, cost: 15};
skill[16] = {what: "skill", type: "skred", title: "Double Strike", trait: "Warrior Skill", trig: 22, text: "After Attacking:<br>If a Warrior kills an Enemy,<br>that Warrior deals Damage to<br>the next Enemy too.", perc: 10, cost: 10};
skill[17] = {what: "skill", type: "skblue", title: "Lifesaver Aura", trait: "Cleric Skill", trig: 6, text: "After Combat:<br>If you have a Cleric present, each present Unit with 4 or less HP regains 4 Health.", perc: 10, cost: 15};
skill[18] = {what: "skill", type: "skpurp", title: "Hasten Spell", trait: "Mage Skill", trig: 1, text: "Before Combat:<br>If you have a Mage in your hand, give all your units +4 Speed.", perc: 10, cost: 15};
skill[19] = {what: "skill", type: "skgreen", title: "Show You the Way", trait: "Ranger Skill", trig: 1, text: "Before Combat:<br>If you have a Ranger present,<br>turn a Disadvantage in your deck<br>into a current Terrain Advantage.", perc: 10, cost: 10};
skill[20] = {what: "skill", type: "skindi", title: "Hidden Daggers", trait: "Rogue Skill", trig: 22, text: "After Attacking:<br>When a Rogue kills an Enemy,<br>gain +2 Battlescore for each<br>Rogue present.", perc: 10, cost: 10};
...
skill[30] = {what: "skill", type: "skgreen", title: "Agile Maneuvers", trait: "Ranger Skill", trig: 6, text: "At the End of the Round:<br>Keep your Rangers that are<br>assigned to Enemies.", perc: 10, cost: 20};
